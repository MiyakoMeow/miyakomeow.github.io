...
<main class="m-0 mx-auto box-border w-full max-w-350 p-8">
	...
	>
		...
		<div class="mt-4 flex flex-wrap items-stretch justify-center gap-4">
			<div class="flex w-80 flex-col rounded-[14px] border border-white/10 bg-black/20 p-5 text-white/50">
				<div class="mb-2 text-[1.2rem] font-bold text-[#64b5f6]/50">难度表镜像</div>
				<div class="text-[0.95rem] text-white/50">暂未迁移</div>
			</div>
			<div class="flex w-80 flex-col rounded-[14px] border border-white/10 bg-black/20 p-5 text-white/50">
				<div class="mb-2 text-[1.2rem] font-bold text-[#64b5f6]/50">谱面合集（SP）</div>
				<div class="text-[0.95rem] text-white/50">暂未迁移</div>
			</div>
			<div class="flex w-80 flex-col rounded-[14px] border border-white/10 bg-black/20 p-5 text-white/50">
				<div class="mb-2 text-[1.2rem] font-bold text-[#64b5f6]/50">谱面合集（DP）</div>
				<div class="text-[0.95rem] text-white/50">暂未迁移</div>
			</div>
		</div>
	</div>
